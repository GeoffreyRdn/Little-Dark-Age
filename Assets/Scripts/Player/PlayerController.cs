...
public class PlayerController: MonoBehaviour, IPunInstantiateMagicCallback {
	...
	private void OnSceneLoaded(Scene scene, LoadSceneMode loadSceneMode) => ResetCameras();
	...
	public void OnPhotonInstantiate(PhotonMessageInfo info) => info.Sender.TagObject = gameObject;
